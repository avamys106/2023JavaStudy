...
public class E06LocalDateTime {
	...
	public static void main(String[] args) {
		...
		//날짜와 시간의 서식을 적용
		DateTimeFormatter formet1 = 
				DateTimeFormatter.ofPattern("yyyy년 MM월 dd일");
		DateTimeFormatter formet2 = 
				DateTimeFormatter.ofPattern("HH시 mm분 ss초");
		DateTimeFormatter formet3 = 
				DateTimeFormatter.ofPattern("오늘은 M월의 W번째주, d번째날, F번째 E요일");
		//앞에서 지정한 서식을 날짜에 적용해서 출력한다. 
		System.out.println("서식1 : "+ monent.format(formet1));
		System.out.println("서식2 : "+ monent.format(formet2));
		System.out.println("서식3 : "+ monent.format(formet3));
		
		//특정날짜 지정하기 : LocalDate.of(년, 월, 일)
		LocalDate xMas = LocalDate.of(localDate.getYear(), 12, 25);
		//앞에서 지정했던 날짜서식을 적용해서 출력한다.
		System.out.println("크리스마스 : "+ xMas.format(formet1));
