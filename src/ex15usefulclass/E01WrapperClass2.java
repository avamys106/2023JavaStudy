...
public class E01WrapperClass2 {
	...
	public static void main(String[] args) {
		...
		codePointAt() : 문자열에서 특정 index에 해당하는 한문자의
			아스키코드를 반환한다. 
		*/
		System.err.println("ABCD에서 3번째 인덱스 D의 아스키코드");
		...
		isDigit() : 인수로 전달된 문자가 숫자인지 판단한다. 숫자인
			경우 true를 반환한다. 
		 */
		System.err.println("isDigit()를 통한 숫자판단");
		...
		System.err.println("isLetter()메소드를 통한 문잔판단");
		...
		System.err.println("isWhitespace() 메소드로 공백문자 판단");
		...
		System.err.println("알파벳 대소문자 판단");
