...
public class E02StringMethod4 {
	...
	/*
	 * 시나리오1] 주민등록번호를 이용하여 성별을 판단하는 프로그램을 charAt()을 이용해서 작성하시오. 190419-3000000 => 남자
	 * 190419-4000000 => 여자
	 */

//	public static void main(String[] args) {
//		String gender = "190419-3000000";
//		if (gender.charAt(7)== '3' || gender.charAt(7)== '1') {
...
//	}
	...
	public static void main(String[] args) {
		...
		/*
		 * 주민번호로 주어진 문자열의 8번째 문자 즉 인덱스7에 해당하는 문자가 성별을 표현하므로 이를 통해 판단한다. 추출했을때는 char형이므로
		 * '(싱글쿼테이션)'으로 비교해야한다.
		 */
		...
		/*
		 * 시나리오2] 해당 문자열이 이메일 형식인지 검사하는 프로그램을 contains()를 이용해서 작성하시오. hong@daum.net =>
		 * 이메일형식임 not@naver => 이메일형식이아님
		 */

//		String mailCheck = "avamys106@gmail.com";
//		System.out.println(mailCheck.contains("@"));
//		if (mailCheck.contains("@") && mailCheck.contains(".")) {
...
//		}
		...
		이용해서 작성하시오.
		*/	
//		String gender2 = "190419-3000000";
//		System.out.println(gender2.indexOf("-")+1);
//		int num = gender2.indexOf("-")+1;
//		System.out.println(num);
//		if(gender2.charAt(num)=='1' || gender2.charAt(num)=='3') {
//			System.out.println("남자");
//		} else if (gender2.charAt(num)=='2' || gender2.charAt(num)=='4') {
//			System.out.println("여자");
//		} else if (gender2.charAt(num)=='5' || gender2.charAt(num)=='6') {
